...
public class App {
	...
	public static void main(String[] args) {
		...
		autoren2.add("Walther Kehrfeld");
				
		Buch buch = new Buch("Titeltest", "Verlagtest", true, autoren, "200", 
				null, null, "Hartband", "1", 423895, "gutes Buch", "12345678", "Suaheli");
		
		Buch buch2 = null;
		try {
			buch2 = new Buch("Die Welt und Ich", "Yen Press", true, autoren2, "1124", 
					null, null, "Hartband", "1", new SimpleDateFormat("dd.mm.yyyy").parse("22.01.2010").getTime(), "", "12345678", "Deutsch");
		...
		HashSet<Medium> set;
		set = best.keysToMedia(best.getSuche().suche("verlag:Yen_press"));
