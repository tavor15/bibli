...
public class App 
{
    ...
    public static void main( String[] args ) {
       ...
       log("Bibli v0.1\nWillkommen im System!");
        ...
        bestand.getInhalt().elements().nextElement().getInhalt().elements().nextElement().add(bestand,new Buch(
        		"Structure and Interpretation of Computer Programms",
        		"MIT-Press",false,autoren, 200, null, null, "Festeinband", 1, date1, 
        		"Wenn du sonst nichts zu tun hast, lies SICP!", "0262010771", "Englisch"));
        
        //teste hash-Funktion
        if(bestand.getInhalt().elements().nextElement().getInhalt().elements().nextElement().add(bestand,new Buch(
        		"Structure and Interpretation of Computer Programms",
        		"MIT-Press",false,autoren, 200, null, null, "Festeinband", 1, date1, 
        		"Wenn du sonst nichts zu tun hast, lies SICP!", "0262010771", "Englisch"))){
        ...
        bestand.getInhalt().elements().nextElement().getInhalt().elements().nextElement().add(bestand,new Buch("Fun with Arithmetics",
        		"Bertold-Brecht-Verlag", false,autoren2, 100, null, null, 
        		"Taschenbuch", 4, date2, "Dieses Buch muss nicht wirklich existieren.", "0129348715", "Englisch"));
        
       
        Enumeration<Integer> keys = bestand.getInhalt().elements().nextElement().getInhalt()
        		.elements().nextElement().getInhalt().keys();
